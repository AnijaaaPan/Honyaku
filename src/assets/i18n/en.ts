const en = {
  commands: {
    advisor: {
      delete: {
        ...
        description: 'Delete Advisor Role'
      },
      description: 'Advisor Relations',
      list: {
        description: 'Displays a list of advisor roles'
      },
      set: {
        completed: '>>> **※Advisor Roles have been created.**',
        contentYesNo: '**Create an advisor role?**',
        description: 'Create an advisor role',
        embed: {
          description: '**{0}: {1} reaction point**'
        },
        hasSamePointData: '>>> **※A role with the same points has already been set up**'
      }
    },
    autoVc: {
      channel: {
    ...
    options: {
      ...
      point: 'Specify reaction points required for the position',
      role: 'Specify Role'
    },
    processing: '**※Processing in progress...**',
    rolePannel: {
      description: '※We will install a roll panel exclusively for this mackerel.',
      embed: {
        title: 'Role Pannel:'
      }
    }
  ...
  rolePannel: {
    addMessage: '>>> **※Add Role: <@&{0}>**',
    removeMessage: '>>> **※Remove Role: <@&{0}>**',
    undefinedGetRoleId: '>>> **※Unexpected CustomID is being processed**'
  },
